class MyStrings{
  static const String appName       = "Asiel";
  ...
  static const String deleteAccountMessage = "NB: You will lose access to all you order history, saved addresses, and profile information.";
  ...
  static const String loginWelcomeMessage   = "Sing in to access product order track and get new offer and update your buying experience";
  static const String regWelcomeMessage     = "Sing up to access product order track and get new offer and update your buying experience";
  ...
  static const String watchDec    = "Experience precision and style with our ChronoMaster Elite. Designed for both elegance and functionality, this watch offers timeless appeal with modern technology. ";
  static const String headphoneDec    = "Immerse yourself in superior sound with the SonicPulse Wireless Headphones. Featuring noise-cancellation and long-lasting comfort, .";
  static const String fashionDec    = "Elevate your wardrobe with our LuxeLayer Jacket. Crafted from premium materials, this jacket combines sophistication with comfort..";
  static const String smartPhoneDec    = "Discover cutting-edge technology with the InfinityEdge Smartphone. With its sleek design and advanced features, it offers a seamless user experience and top-notch performance. S.";
  static const String bagDec    = "Carry your essentials in style with our Urban Voyager Backpack. Designed for durability and convenience.";
  static const String shoesDec    = "Upgrade your stride with our Xtreme Grip 2024 Sneakers. Built for ultimate comfort and traction, these sneakers excel in both style and performance. ";
