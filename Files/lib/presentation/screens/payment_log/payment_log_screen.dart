...
import 'package:ShapeCom/domain/controller/payment_log/payment_log_controller.dart';
import 'package:ShapeCom/domain/controller/payment_log/payment_log_controller.dart';
...
import 'package:ShapeCom/presentation/components/divider/horizontal_divider.dart';
import 'package:ShapeCom/presentation/screens/payment_log/widget/payment_log_cart.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<PaymentLogController>(
        builder: (controller) => Scaffold(
          ...
          body: ListView(
            children: List.generate(2, (index) => PaymentLogCart(controller: controller)),
          ),
        )
    );
  }
