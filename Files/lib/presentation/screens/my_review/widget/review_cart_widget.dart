...
import 'package:ShapeCom/presentation/screens/my_review/widget/submit_review_bottom_sheet.dart';
    ...
    return Column(
      children: [
        Row(
          children: [
            GestureDetector(
              onTap: () => Get.toNamed(RouteHelper.productDetailsScreen2,arguments: productModel),
              child: Row(
                children: [
                  Container(
